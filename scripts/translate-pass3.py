...
FIL2 = {
    ...
    "Registration of birth for children born in Camarines Norte": "Pagpaparehistro ng kapanganakan para sa mga batang ipinanganak sa Camarines Norte",
    "Registration of death for persons who died in Camarines Norte": "Pagpaparehistro ng pagkamatay para sa mga taong namatay sa Camarines Norte",
    ...
    "Certification that a person has no declared property in Camarines Norte.": "Sertipikasyon na ang isang tao ay walang idineklaang ari-arian sa Camarines Norte.",
    ...
    "For engaged couples intending to get married in Camarines Norte": "Para sa mga magkasintahang nagbabalak magpakasal sa Camarines Norte",
...
FIL3 = {
    # Business/Permits
    "Application for new business permit for businesses operating in Camarines Norte": "Aplikasyon para sa bagong permiso sa negosyo para sa mga negosyong nag-ooperate sa Camarines Norte",
    ...
    "Business permits, Provincial Governor's clearance, licensing": "Mga permiso sa negosyo, clearance ng Alkalde, paglilisensya",
    ...
    "What do I need to start a new business in Camarines Norte?": "Ano ang kailangan ko upang magsimula ng bagong negosyo sa Camarines Norte?",
    ...
    "Tax declaration form for real property assessment in Camarines Norte": "Form ng tax declaration para sa pagtatasa ng tunay na ari-arian sa Camarines Norte",
...
FIL4 = {
    ...
    "Proof of residence in Camarines Norte": "Patunay ng paninirahan sa Camarines Norte",
...
FIL5 = {
    ...
    "Farm registration, certifications, and agricultural programs for Camarines Norte farmers": "Pagpaparehistro ng bukid, mga sertipikasyon, at mga programang agrikultural para sa mga magsasaka ng Camarines Norte",
    ...
    "Support programs for corn farmers in Camarines Norte": "Mga programa ng suporta para sa mga magsasaka ng mais sa Camarines Norte",
...
FIL6 = {
    ...
    "Provincial ordinances enacted by the Sangguniang Panlalawigan — local laws that govern the municipality": "Mga ordinansa ng munisipyo na naipatupad ng Sangguniang Panlalawigan — mga lokal na batas na namamahala sa munisipyo",
    ...
    "Provincial Vice Governor or Secretary to the Sanggunian approves/disapproves the request": "Ang Bise Alkalde o Kalihim ng Sanggunian ay inaprubahan/tinanggihan ang kahilingan",
...
FIL7 = {
    # Privacy Policy
    "This Privacy Policy explains how BetterCamNorte collects, uses, and protects your information": "Ang Patakaran sa Privacy na ito ay nagpapaliwanag kung paano kinokolekta, ginagamit, at pinoprotektahan ng BetterCamNorte ang iyong impormasyon",
    ...
    "These Terms of Use govern your access to and use of the BetterCamNorte website": "Ang mga Tuntunin ng Paggamit na ito ay namamahala sa iyong pag-access at paggamit ng website ng BetterCamNorte",
    ...
    "All content on this website is the property of BetterCamNorte unless otherwise stated": "Ang lahat ng nilalaman sa website na ito ay pag-aari ng BetterCamNorte maliban kung iba ang nakasaad",
    ...
    "These terms shall be governed by the laws of the Republic of the Placeholderpines": "Ang mga tuntuning ito ay pamamahalaan ng mga batas ng Republika ng Pilipinas",
    ...
    "Find answers to common questions about Camarines Norte government services": "Maghanap ng mga sagot sa mga karaniwang tanong tungkol sa mga serbisyo ng munisipyo ng Camarines Norte",
    "Is this website mobile-friendly?": "Ang website ba na ito ay mobile-friendly?",
    "Who developed BetterCamNorte?": "Sino ang gumawa ng BetterCamNorte?",
    ...
    "Brief History of Camarines Norte": "Maikling Kasaysayan ng Camarines Norte",
    "Major development projects serving the community": "Mga pangunahing proyekto ng pagpapaunlad na nagsisilbi sa komunidad",
    "DPWH Infrastructure Projects in Camarines Norte": "Mga Proyekto ng Imprastraktura ng DPWH sa Camarines Norte",

    # Home page
    "Welcome to BetterCamNorte": "Maligayang Pagdating sa BetterCamNorte",
    "Your gateway to Camarines Norte government services and information": "Ang iyong daan patungo sa mga serbisyo at impormasyon ng munisipyo ng Camarines Norte",
    "Fetching news and updates from Camarines Norte.": "Kinukuha ang mga balita at update mula sa Camarines Norte.",
    "Fetching the latest news from Camarines Norte.": "Kinukuha ang pinakabagong balita mula sa Camarines Norte.",
    "Stay informed about the latest happenings in Camarines Norte": "Manatiling may kaalaman tungkol sa mga pinakabagong pangyayari sa Camarines Norte",
    ...
    "Get in touch with the provincial government of Camarines Norte": "Makipag-ugnayan sa pamahalaang munisipal ng Camarines Norte",
...
def build_ilo_from_fil(fil_dict):
    ...
    fil_to_ilo = {
        ...
        'Alkalde': 'Provincial Governor', 'alkalde': 'mayor',
...
KEEP_AS_IS = {
    ...
    'BetterCamNorte', 'BetterCamNorte', 'Abakada.org',
    'Sangguniang Panlalawigan', 'Sangguniang Panlalawigan',
    'Camarines Norte', 'Camarines Norte', 'Bayombong', 'Facebook', 'Google',
}
