...
PHRASES_FIL = {
    ...
    "BetterCamNorte is committed to ensuring digital accessibility for people with disabilities": "Ang BetterCamNorte ay nakatuon sa pagtiyak ng digital na accessibility para sa mga taong may kapansanan",
    "BetterCamNorte is committed to ensuring that our digital services are accessible to all citizens, regardless of ability": "Ang BetterCamNorte ay nakatuon sa pagtiyak na ang aming mga digital na serbisyo ay naa-access ng lahat ng mamamayan, anuman ang kakayahan",
    ...
    "BetterCamNorte is a civic platform dedicated to empowering the people of Camarines Norte by providing transparent access to": "Ang BetterCamNorte ay isang civic platform na nakatuon sa pagbibigay-kapangyarihan sa mga tao ng Camarines Norte sa pamamagitan ng pagbibigay ng transparent na access sa",
    "BetterCamNorte is a general audience website providing civic information": "Ang BetterCamNorte ay isang website para sa pangkalahatang madla na nagbibigay ng civic na impormasyon",
    "BetterCamNorte provides public domain information to support civic engagement, transparency, and informed participation": "Ang BetterCamNorte ay nagbibigay ng impormasyon sa public domain upang suportahan ang civic engagement, transparency, at may kaalamang pakikilahok",
    "BetterCamNorte values accuracy, public safety, and respect for rights": "Pinahahalagahan ng BetterCamNorte ang katumpakan, kaligtasan ng publiko, at paggalang sa mga karapatan",
    ...
    "BetterCamNorte cannot guarantee that the website will be": "Hindi magagarantiya ng BetterCamNorte na ang website ay magiging",
    ...
    "Official Camarines Norte Provincial Government Portal": "Opisyal na Portal ng Camarines Norte Provincial Government",
