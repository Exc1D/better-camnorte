/**
 * Weather & Map Section for BetterCamNorte Homepage
 * Displays real-time weather data and interactive map of Camarines Norte
...
(function () {
  ...
  const WeatherService = {
    CACHE_KEY: 'camnorte_weather_cache',
    CACHE_TTL: 30 * 60 * 1000,
    API_URL: 'https://api.open-meteo.com/v1/forecast',
    COORDINATES: { lat: 14.1122, lon: 122.9553 },
  ...
  const WeatherUI = {
    render(container, data) {
      ...
      try {
        ...
        container.innerHTML = `
                <div class="weather-widget" role="region" aria-label="Current weather in Camarines Norte">
                    <div class="weather-current">
                        ...
                        <div class="weather-current-info">
                            ...
                            <div class="weather-current-location">
                                <i class="bi bi-geo-alt" aria-hidden="true"></i> Camarines Norte
                            </div>
                        </div>
                    </div>
  ...
  // ============================================================================
  const MapComponent = {
    CAMNORTE_CENTER: [14.1122, 122.9553],
    DEFAULT_ZOOM: 14,
    map: null,
    ...
    initLeaflet(container) {
      try {
        ...
        // Add marker
        const marker = L.marker(this.CAMNORTE_CENTER).addTo(this.map);
        marker.bindPopup('<strong>Camarines Norte Provincial Capitol</strong><br>Camarines Norte 3708');
